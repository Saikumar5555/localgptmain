...
@app.get("/response/")
async def read_item(prompt: str = Query(..., description="Prompt for the query"),
                    collection_name: str = Query(..., description="Name of the collection"),
                    session_id: str = Query(..., description="ID of the session")):
    try:
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail=f"Error initializing Chroma retriever: {e}")
